...
export const SEARCH_MEMORY_SHAPE = {
  query: z.string().min(1).optional().describe("Optional literal subject/transcript terms, e.g. 'travel insurance'. Omit for category-only lists; use contentType and order instead."),
