...
const report={classifier:models.classifyModel,askModel:models.askModel,organizerReasoningEffort:models.organizerReasoningEffort??null,mode:a['source-repo']?'ACTUAL_NATIVE_CANDIDATE_ASR_MEDIA_QUEUE':'ACTUAL_IMAGE_CANDIDATE_ASR_MEDIA_QUEUE',candidateSha:a['candidate-sha'],capturedAt:a['captured-at'],audioSha256:hash(audio),sourceSha256:hash(source),modelSha256:a['model-sha256'],workspace,startedAt:new Date().toISOString(),semanticEvaluation:'NOT_EVALUATED',recalls:[],budgetBlocks,budgetUsd:0.5,seedSha256:hash(seedBytes),pricesSha256:hash(pricesBytes),questionsSha256:hash(questionsBytes),driverSha256:hash(await readFile(fileURLToPath(import.meta.url))),phoneIngress:false};
