...
- **ZD-13 · Stripe environment split — DECIDED 2026-07-09 (Jordi): `cloud-test` is test,
...
### 2026-07-09 · [worker/cloud-billing] ZD-13 recorded — Stripe TEST/LIVE split for Zenod checkout drills
...
### 2026-07-09 · [SUPERSEDED historical note] Customer GitHub authority proposed as OAuth only

> Superseded the same day by **Epic 2.3 auth correction** above. Preserve this entry as execution
> history only. Do not implement broad OAuth `repo` scope or remove the shared restricted GitHub App.
