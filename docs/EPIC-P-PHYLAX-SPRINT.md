...
Fresh base commit: `17818127d19a332ff8164d5c968f93a7c7b5bb80` on `main`; signup-closed production candidate remains deployed and is the rollback/behavior baseline, not target-architecture proof
...
Next action: finish #1104's capability-scoped route surface and volume-bound island identity while #1107 implements the tenant-safe management MCP from exact integrated `main`; independently review and integrate each exact head.
Blockers: #1104 remains merge-blocked until its two bounded artifact-separation findings pass exact image/restart review. No architecture decision is open. Production deployment, real channel sends, real-card billing and public signup remain later named human gates. Exact plan allowance amounts, allocation chunk sizes and native Phylax pricing are configuration/commercial choices that cannot change the ledger or service architecture.
...
| [#1107](https://github.com/zenod-ai/zenod/issues/1107) | Ticket worker | ZPF-5-worker | Tenant-safe Phylax management MCP | active / wave 2 | #1105, #1106 | `codex/zpf-5-management-mcp` | `1781812` | Versioned, scoped, idempotent tenant/channel/credit tools; separate owner surface; hostile and rolling-version matrix green. | Dispatched from exact integrated `main` after #1105/#1106; dedicated worktree/branch required | 2026-08-27 16:38 CEST | Implement bounded management MCP contract; PR + exact tests/CI + independent review, no production mutation. |
...
- Default integration branch: protected `main`; current coherent wave-1 base is `17818127d19a332ff8164d5c968f93a7c7b5bb80` after integrating #1103, #1105, #1106 and #1119.
...
- Wave 1 integrated #1103, #1105, #1106 and #1119; #1104 remains in its exact artifact review-fix loop while dependency-ready #1107 runs from the newest coherent `main`. Later waves obey the dependencies recorded above.
