...
Phase: Final architecture frozen; wave 1 integration and bounded review-fix loop
Last verified: 2026-08-27 16:25 CEST
Integration target: main
Fresh base commit: `264955371bbf85b44be5540448f0e1e8998889b8` on `main`; signup-closed production candidate remains deployed and is the rollback/behavior baseline, not target-architecture proof
...
Next action: integrate the exact reviewed #1119 durable-chat repair, finish #1104's Phylax-only route-surface review and #1106's deterministic period-boundary correction, then dispatch #1107 from the resulting coherent `main`.
Blockers: #1104 remains under exact route-surface review and #1106 must close deterministic closed-period enforcement before merge. No architecture decision is open. Production deployment, real channel sends, real-card billing and public signup remain later named human gates. Exact plan allowance amounts, allocation chunk sizes and native Phylax pricing are configuration/commercial choices that cannot change the ledger or service architecture.
...
| [#1104](https://github.com/zenod-ai/zenod/issues/1104) | Ticket worker | ZPF-2-worker | Independent Phylax artifact and isolated instance modes | active / wave 1 review-fix | none | [#1117](https://github.com/zenod-ai/zenod/pull/1117) / `codex/zpf-2-phylax-artifact` | `3e902f4` | Dedicated Phylax artifact boots multiple isolated fixed-product/standalone instances with no shared runtime data and no Zenod process embedded. | Corrected head `c1fb7e3`; CI and local image/runtime proofs green; independent review is checking the exact customer/admin route surface | 2026-08-27 16:25 CEST | Hold merge until exact route-surface review returns PASS and current `main` is reconciled. |
...
| [#1106](https://github.com/zenod-ai/zenod/issues/1106) | Ticket worker | ZPF-4-worker | Issuer-neutral Phylax allowance and usage ledger | active / wave 1 review-fix | none | [#1118](https://github.com/zenod-ai/zenod/pull/1118) / `codex/zpf-4-phylax-ledger` | `913efeb` | Append-only integer ledger gives exactly-once tenant grants/adjustments/usage, deterministic reset/suspension and custody-preserving cap behavior. | Head `2868019` closed lease/cap settlement P1s and passed CI; independent review found direct usage after period close depended on whether projection ran first | 2026-08-27 16:25 CEST | Enforce period boundary atomically in usage/settlement, add order-independence/restart tests, then re-review exact corrected head. |
| [#1119](https://github.com/zenod-ai/zenod/issues/1119) | Ticket worker | ZPF-1R-worker | Repair the real durable chat MCP declaration seam | needs review / wave 1 repair | #1103 | [#1120](https://github.com/zenod-ai/zenod/pull/1120) / `codex/zpf-1r-durable-chat-contract` | `2649553` | `chat_with_zenod` has one canonical accepted/poll contract while ordinary synchronous chat remains compatible; replay and tenant isolation remain exact. | Corrected head `344ba6e`; exact CI green; malformed blank/non-string ticket claims now route to strict rejection | 2026-08-27 16:25 CEST | Run final independent exact-head re-review, then merge if PASS. |
...
- Default integration branch: protected `main`; current coherent wave-1 base is `264955371bbf85b44be5540448f0e1e8998889b8` after integrating #1103 and #1105.
...
- Wave 1 integrated #1103 and #1105; #1119 is the bounded source repair exposed by #1103, while #1104 and #1106 remain in exact review-fix loops. Later waves obey the dependencies recorded above.
