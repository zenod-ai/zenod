...
Last reconciled commit: `7403d0c`
...
Phase: DX-2 complete; DX-3..5 execution packages merged; migration-gated execution
Last verified: 2026-07-10 05:17 CEST
Integration target: main
Fresh base commit: `7403d0c520c8748e8a8d3cb6ee9923fbc2146d07`
Next action: consume accepted migration receipts as the owning child epics land them. #728 requires Z-MT-6 Gate 2; #729 requires the parent pilot and CA-MT-6 plus exact classification; #730 requires the pilot/spawner/E-MT-7 and a fresh fleet proof. Keep cloud `tenants_api` off until the actual unit runtimes and control-plane tokens exist, then prove one Stripe TEST checkout per unit on cloud-test.
Blockers: the Zenod pilot is active but has not reached Z-MT-6; Epic 3.3 and 3.5 remain draft behind that pilot, and Ring is later in the parent sequence. Alpha9 has no canonical multi-tenant Callisthenes or Ring runtime; `zenod-z2` still exposes legacy `ZENOD_AWAIT_PROVISION` mode without a `CONTROL_PLANE_TOKEN`. The last public probe remained Zenod 401, Callisthenes 404, Ring 404. Live waves additionally require exact digest/window/archive/rollback approval. DX-2 has no remaining blocker.
...
| [#728](https://github.com/zenod-ai/zenod/issues/728) | Ticket worker | Hooke (`019f49f1-f978-7110-9dbf-f1b1a5ffd7a4`) | DX-3 Zenod retirement wave | blocked / package merged | 3.2 Z-MT-6 Gate 2 + #714 | [PR #787](https://github.com/zenod-ai/zenod/pull/787) merged as `7403d0c`; prep `codex/epic37-dx3-zenod-wave` | `1d7f440` | All per-user Zenods retired with per-tenant verification. | Exact one-row manifest and fail-closed dry-run validator are on main. Candidate is live-paying `zenod-jordi-f2c7a6`; 35 focused tests pass. There is no apply mode. | 2026-07-10 05:13 CEST | Consume accepted Z-MT-6 Gate 2, migration/data proof, shared-host token continuity, rollback checkpoint, archive target, and Jordi's digest/window approval before adding or running an apply path. |
| [#729](https://github.com/zenod-ai/zenod/issues/729) | Ticket worker | Pasteur (`019f49f1-f9ef-7ed3-b6ba-0fc552f151f7`) | DX-4 Callisthenes retirement wave | blocked / package merged | parent pilot + 3.3 CA-MT-6 + #714 | [PR #787](https://github.com/zenod-ai/zenod/pull/787) merged as `7403d0c`; prep `codex/epic37-dx4-callisthenes-wave` | `1d7f440` | All per-user Callisthenes retired with per-tenant verification. | Exact remaining row is deliberately `unknown`: `callisthenes-jordicallifresh33087-muhmxp`. Dry-run validator and receipt schema are on main; 8 focused tests pass. There is no apply mode. | 2026-07-10 05:13 CEST | Consume pilot and CA-MT-6 receipts, exact classification/tenant binding, credential isolation, `calli.zenod.dev` token continuity, rollback snapshot, archive target, and Jordi's digest/window approval. |
| [#730](https://github.com/zenod-ai/zenod/issues/730) | Ticket worker | Meitner (`019f49f1-fa41-7660-aa14-148e3453a34c`) | DX-5 Epaminon retirement wave | blocked / package merged | parent pilot + spawner decision + 3.5 E-MT-7 + #714 | [PR #787](https://github.com/zenod-ai/zenod/pull/787) merged as `7403d0c`; prep `codex/epic37-dx5-epaminon-wave` | `1d7f440` | All per-user Epaminons retired; AWAIT_PROVISION fleet gone. | Scope packet proves zero separate live per-user Epaminon rows in the baseline; the retained unknown Ring suite bundles an Epaminon executor and canonical shared `epaminon` is not a tenant target. Validator tests pass. | 2026-07-10 05:13 CEST | Obtain fresh inventory plus pilot/spawner/E-MT-7/sandbox proof and exact discovered-row archive/rollback/removal approval; do not target the shared canonical Epaminon row. |
