...
Last reconciled commit: `d3137a5`
Planner: Epic 3.0 planner
Worker: Epic 3.7 delivery manager + dispatched ticket workers
Tester: DX-7 final tester + independent acceptance reviewers dispatched
...
| Ticket worker | Dalton (`019f493b-5e40-7bd2-b3d5-98c1d6f8aeb9`), Descartes (`019f493b-5ec9-73c1-bd3a-450ab687796c`), Hooke (`019f49f1-f978-7110-9dbf-f1b1a5ffd7a4`), Pasteur (`019f49f1-f9ef-7ed3-b6ba-0fc552f151f7`), Meitner (`019f49f1-fa41-7660-aa14-148e3453a34c`), Faraday (`019f493b-5f51-7352-9bf4-9b4ee36888ea`), Franklin (`019f4943-96fe-78b0-89fb-f17df5738be7`), Galileo (`019f4950-33d0-7cb2-b779-1b447e381fab`), Ptolemy (`019f497f-29d7-7d73-bb60-582e94da0c6f`), Zeno (`019f4a18-5a81-74e3-a238-32b286a81e24`), Huygens (`019f4a18-615c-7471-bfcb-346c1551e1e5`) | #714, #722, #728, #729, #730, #731, #741, #745, #756, #793, cloud #62 | Execute assigned issue branches. | PR/patch, commit, evidence, blocker, next action. |
| Tester | Lovelace (`019f493b-5fe8-77e1-85d3-df536f8f2059`), Heisenberg (`019f4950-3452-7863-b296-fe04c2cb2ecf`), Hypatia (`019f497f-2a30-7eb0-a156-c2ea3075573b`), Feynman (`019f4a0d-7751-7231-8298-a924919ed121`), Avicenna (`019f4a5b-6941-7993-bd10-aa80e47b0f10`) | #732; DX-1/DX-2 safety review; #756 acceptance review; upstream #736/#738 acceptance | Validate runbooks, execution-package readiness, checkout topology, and migration-gate evidence. | Commit, environment, pass/fail, risk. |
| Observer | Pascal (`019f4a0e-2228-73e1-8a47-d89e1a97d4c6`) | #729/#730 classification + fleet drift | Read-only correlation; never mutate production or spines. | Evidence, confidence, side effects, next proof. |
...
- [x] DX-1 inventory: the original authoritative inventory and #793 post-probe refresh classify every remaining row, including the new record-only duplicate and the suite-bundled Ring executor.
- [ ] DX-2 early wins: the approved 17-row batch is complete, but two retained rows are now classified `test` and one new record-only duplicate exists; a new exact packet and approval are required before any additional removal.
...
Phase: DX-1/DX-2 package complete; cloud recovery fix merged; upstream Zenod pilot rejected at new exact head
Last verified: 2026-07-10 07:25 CEST
Integration target: main
Fresh base commit: `d3137a554c7fd6d7703129d2e350098000ba7fbd`
Next action: Jordi must explicitly approve marker commits to the three named disposable repositories and mint/provide one capped non-production OpenRouter key for the exact `e3a264b` full-mode run. Epic 3.2 then executes and independently validates fresh hosted/browser/self-host/migration/restore evidence before #738 may enter P0. Separately prepare exact operator packets for cloud route ownership correction and any DX-2C cleanup; neither approval is implied by the pilot resource gate. Keep cloud `tenants_api` off.
Blockers: #789 is merged and #792's migration implementation is in draft PR #791. Exact head `e3a264b` passes CI, publish/smoke, pre-push and post-push OCI revision checks, and independent focused custody/identity review; immutable image index is `sha256:98e3ae1b4a3b9d8b7bbd47624379a9d1fd70cd98f2fe80c5b1d5017e02546683`. Code readiness for the previously reported findings is PASS, but no fresh full browser/self-host/migration package exists because the capped test inference key and marker commits to three existing disposable repos require Jordi's exact approval. Epic 3.3 and 3.5 remain draft; Alpha9 has no canonical multi-tenant Callisthenes/Ring runtime; endpoints remain 401/404/404. Cloud #62 is code-complete, but duplicate cleanup and hostname ownership correction remain separate exact human gates. Live waves still require digest/window/archive/rollback approval. DX-2 itself remains complete.
...
| 2026-07-10 | Classify retained Callisthenes `NR_px8Ul2L2w_RaM4-DWe` and Ring `a5BbpChW5PKgXUJFZSUNo` rows as Stripe TEST, not live-paying; the Ring-bundled Epaminon executor is not an independent tenant. | Exact Stripe TEST sessions, owner emails, slug derivation, queue timing, Dokploy descriptions, and Epic 2.4 receipt agree. | read-only classification audit `019f4a0e-2228-73e1-8a47-d89e1a97d4c6`; #729/#730 |
| 2026-07-10 | A status endpoint is observational only; it may never reconcile or provision. Cross-environment checkout mismatch returns 409, and provisioning success must bind to the exact new compose/container/domain/token rather than a shared hostname. | Live logs proved deployed `status-reconcile` GET replayed a cloud-test checkout on the live backend, created a duplicate, then falsely accepted the original hostname. | cloud #62 comment `4931765367`; audit `019f4a0e-2228-73e1-8a47-d89e1a97d4c6` |
...
| [#793](https://github.com/zenod-ai/zenod/issues/793) | Ticket worker | Zeno (`019f4a18-5a81-74e3-a238-32b286a81e24`) | DX-1B classify retained test rows and refresh post-probe inventory | done | #714; cloud #62 informs cause | [PR #795](https://github.com/zenod-ai/zenod/pull/795) merged as `77d8e39`; worker `78c786c` + `ebfb51e`; integration `9f4cd53` | Fresh exact inventory; Callisthenes/Ring test classifications; suite-bundled Epaminon topology; fail-closed duplicate packet; no apply. | Fresh current-state/checksum and exact duplicate candidate/checksum are on main. Independent combined tests and CI pass; issue closed package-complete. | 2026-07-10 06:01 CEST | Complete; cleanup remains a separate digest-bound human gate. |
...
| [#728](https://github.com/zenod-ai/zenod/issues/728) | Ticket worker | Hooke (`019f49f1-f978-7110-9dbf-f1b1a5ffd7a4`) | DX-3 Zenod retirement wave | blocked / package merged | accepted #736 full proof + #738 Gate 2 + #714 | [PR #787](https://github.com/zenod-ai/zenod/pull/787) merged as `7403d0c`; prep `codex/epic37-dx3-zenod-wave` | `1d7f440` | All per-user Zenods retired with per-tenant verification. | #789 is merged and #792 is implemented in draft PR #791. Exact head `e3a264b` and immutable image `sha256:98e3ae1b4a3b9d8b7bbd47624379a9d1fd70cd98f2fe80c5b1d5017e02546683` pass CI, publish/smoke, OCI identity, and focused custody enforcement review. Fresh external full-mode acceptance remains unrun. Exact one-row package still has no apply mode. | 2026-07-10 07:25 CEST | Obtain the two exact pilot resource approvals, run accepted full-mode #736, complete #738 migration and observation gates, then obtain Jordi's separate digest/window/archive/rollback approval. |
| [#729](https://github.com/zenod-ai/zenod/issues/729) | Ticket worker | Pasteur (`019f49f1-f9ef-7ed3-b6ba-0fc552f151f7`) | DX-4 Callisthenes retirement wave | blocked / classification done | parent pilot + 3.3 CA-MT-6 + #793 | [PR #787](https://github.com/zenod-ai/zenod/pull/787) merged as `7403d0c`; refresh [PR #795](https://github.com/zenod-ai/zenod/pull/795) merged as `77d8e39` | `1d7f440`; refresh `6f16985` | All per-user Callisthenes retired with per-tenant verification. | Legacy row is evidence-backed `test`, bound to `jordi+calli-fresh-33087769@alpha9.io` and a Stripe TEST session; shared `tenant_id` remains null. A new record-only duplicate exists. There is no apply mode. | 2026-07-10 07:06 CEST | Consume accepted pilot/CA-MT-6, shared tenant binding, credential/receipt isolation, old-token continuity, rollback, archive, and Jordi approval. |
| [#730](https://github.com/zenod-ai/zenod/issues/730) | Ticket worker | Meitner (`019f49f1-fa41-7660-aa14-148e3453a34c`) | DX-5 Epaminon retirement wave | blocked / classification done | parent pilot + spawner decision + 3.5 E-MT-7 + #793 | [PR #787](https://github.com/zenod-ai/zenod/pull/787) merged as `7403d0c`; refresh [PR #795](https://github.com/zenod-ai/zenod/pull/795) merged as `77d8e39` | `1d7f440`; refresh `6f16985` | All per-user Epaminons retired; AWAIT_PROVISION fleet gone. | Ring row is evidence-backed `test`; its Epaminon container/volume are `suite-bundled`, not an independent tenant. Canonical shared `epaminon` remains out of scope. | 2026-07-10 07:06 CEST | Obtain accepted pilot/spawner/E-MT-7/sandbox proof, Ring job-history/archive mapping, fresh inventory, snapshot/rollback, and exact approved removal scope. |
| [#731](https://github.com/zenod-ai/zenod/issues/731) | Ticket worker | Faraday + steward | DX-6 retire provisioner, watchdog registration, DNS minting | blocked / replacement merged off | accepted child cutovers + #745 cloud-test evidence + DX-3..5 | [PR #747](https://github.com/zenod-ai/zenod/pull/747) merged as `430c385`; [cloud PR #59](https://github.com/zenod-ai/cloud/pull/59) merged as `09ca15d` | `8e12ebab64140f227f9c19d5a72e5d191de8d251` | 2.x provisioning code paths removed with tombstones. | Replacement client and guarded source deregistration are merged, but Alpha9 has no canonical multi-tenant Callisthenes or Ring runtime. Recreated `zenod-z2` still awaits provisioning and has no control-plane token. | 2026-07-10 05:17 CEST | Complete child cutovers and #745 cloud-test checkouts, then remove legacy provisioning only after all retirement waves close. |
| [cloud #62](https://github.com/zenod-ai/cloud/issues/62) | Ticket worker | Huygens (`019f4a18-615c-7471-bfcb-346c1551e1e5`) | Make legacy provision recovery duplicate-safe | done / code merged | observed fleet drift; informs #731/#793 | [cloud PR #63](https://github.com/zenod-ai/cloud/pull/63) merged as `065967a`; reviewed head `f9c9df6` | Side-effect-free status; environment mismatch 409; durable resource claim; pre-create adopt/fail closed; exact runtime/domain/token proof; production mode unchanged. | Self tests pass 30 webhook + 30 script tests, typecheck/builds/config/audits; standard live read-only inventory passed across 12 applications; independent adversarial review passed exact head. No production mutation or cleanup occurred. | 2026-07-10 07:05 CEST | Complete; separately correct deployment hostname ownership and clean the exact duplicate only under their explicit operator gates. |
...
| [#745](https://github.com/zenod-ai/zenod/issues/745) | Ticket worker | Galileo (`019f4950-33d0-7cb2-b779-1b447e381fab`) | DX-8 cloud `/api/tenants` checkout replacement | blocked / code merged off | accepted child cutovers; actual Zenod, Callisthenes, and Ring runtimes + tokens | [cloud PR #59](https://github.com/zenod-ai/cloud/pull/59) merged as `09ca15d` | cloud `4300ec34e0a59c4f3689fb789eae460c6d7354d0` | Stripe checkout provisions unit tenant rows instead of Dokploy compose/domain records. | Fail-closed client is on cloud main and production stays off. Public probes are Zenod 401, Callisthenes 404, Ring 404; Alpha9 has no canonical multi-tenant Callisthenes/Ring runtime and `zenod-z2` has no control-plane token. | 2026-07-10 05:17 CEST | Finish the child cutovers and configure actual runtime tokens; then enable on cloud-test only and run one Stripe TEST checkout per unit. |
...
- Integrated 2026-07-10: Zenod PRs #746 (`69bee3a`), #747 (`430c385`), #748 (`e97c259`), #749 (`cd9c21f`), #755 (`fa49f5c`), #778 (`859171b`), #787 (`7403d0c`); cloud PRs #58 (`f21f3f7`), #59 (`09ca15d`), #60 (`039e2cd`), #61 (`3e80e7b`).
...
| DX-2C newly classified test/duplicate batch | Jordi | After #793 produces an exact fresh candidate digest | Approve exact rows, digest, archive target, rollback, and execution window; prior #722 approval does not carry forward | Classification, fail-closed packet, dry-run, and review |
| Epic 3.2 full-mode pilot resources | Jordi | After PR #791 publishes an exact immutable image and closes the remaining evidence-contract P1s | Approve one capped test-only OpenRouter key and marker commits to the three named disposable repos | Contract-mode tests and non-mutating preparation |
| Cloud hostname ownership correction | Jordi | Before removing the live backend's `cloud-test.zenod.dev` route or changing deployed cloud domains | Approve exact current/desired route IDs and rollback; verify cloud-test remains reachable | Merge/test cloud #62 code without deployment |
...
- Hooke (`019f49f1-f978-7110-9dbf-f1b1a5ffd7a4`) completed the fail-closed #728 preparation package; live execution is blocked on Z-MT-6 Gate 2 and the named human gate.
- Pasteur (`019f49f1-f9ef-7ed3-b6ba-0fc552f151f7`) completed the fail-closed #729 preparation package; live execution is blocked on pilot/CA-MT-6 and exact classification.
- Meitner (`019f49f1-fa41-7660-aa14-148e3453a34c`) completed the #730 scope package; execution is blocked on pilot/spawner/E-MT-7 and fresh inventory proof.
...
- Zeno (`019f4a18-5a81-74e3-a238-32b286a81e24`) completed #793; PR #795 merged as `77d8e39` and the issue is closed.
- Huygens (`019f4a18-615c-7471-bfcb-346c1551e1e5`) completed cloud #62; exact head `f9c9df6` passed steward and independent tests, PR #63 merged as `065967a`, and the issue is closed.
...
- Feynman (`019f4a0d-7751-7231-8298-a924919ed121`) independently rejected Epic 3.2 #736/#738 readiness at branch `3688410` / product `2d8509e` despite green automated suites.
- Avicenna (`019f4a5b-6941-7993-bd10-aa80e47b0f10`) independently rejected post-#792 PR #791 head `121e26f`: image publication, immutable identity, explicit custody receipts, and fresh full-mode acceptance remain incomplete.
...
| 2026-07-10 | DX-3..5 live-wave preparation | Zenod `7403d0c` | three isolated worker worktrees plus combined integration PR #787 | DX-3 35 focused tests; DX-4 8 focused tests; DX-5 packet tests; DX-2 guards; all Node script tests 193/193; strict spine validation; JSON/checksum validation; `git diff --check` | pass / execution blocked | Exact fail-closed manifests, gate templates, receipt schemas, runbooks, and validators are on main. No package has an apply mode and no production mutation occurred. |
| 2026-07-10 | Epic 3.2 definitive pilot acceptance for DX-3 | branch `3688410`; product `2d8509e` | `/Users/jordi/Documents/GitHub/wt-736-definitive`; PR #791 | chassis 71; server 576; core 304 + 6 intentional skips; scripts 184; 27 schemas; web 1; artifact parsing and inspection | fail / correctly blocked | #789 exposes a world credential in `vault.sqlite-wal`; retained evidence is contract mode without durable commit/marker receipts; browser, self-host, and full migration/restore acceptance are incomplete. #738 cannot enter P0/Gate 1/Gate 2. Child steward accepted the audit and reconciled #736/#738. |
| 2026-07-10 | Pilot full-mode credential feasibility | PR #791 harness and operator stores | read-only local Keychain/Dokploy/GitHub metadata | credential-presence probes; repo permission checks; no secret values emitted | partial / human gate later | Three existing private writable repos qualify; no eligible raw test inference key exists. After the exact image and evidence-contract P1s close, Jordi must approve one capped test key and marker commits to the named repos. Production keys are excluded. No mutation occurred. |
| 2026-07-10 | Retained-row classification and drift probe | live Stripe TEST/account metadata + Alpha9 read-only state | Callisthenes/Ring legacy rows and live/test backend stores | exact session/slug/owner/Dokploy correlation; topology trace; nanosecond log/account/queue/Dokploy timeline | pass / inventory stale | Both retained rows are TEST, not live-paying. Ring's Epaminon executor is suite-bundled. Deployed live `status-reconcile` GET directly created idle duplicate `Us9aDVdhvlObXLDfDwW0I` after cross-environment routing, then falsely accepted the original hostname. #793 owns the refreshed packet; cloud #62 owns the regression. |
| 2026-07-10 | DX-1B classification and duplicate packet integration | worker `78c786c` + `ebfb51e`; integration `9f4cd53` | isolated worker + steward integration worktrees | DX-1B 7/7; DX-4 8/8; DX-5; DX-3 35/35; DX-2 guards; Node scripts 193/193; JSON/checksums; strict spine; diff check | pass / no apply | Exact fresh state and candidate digests bind the two TEST rows and one record-only duplicate; Ring Epaminon remains suite-bundled; validator rejects stale causation and exposes no live control path. No production mutation occurred. |
| 2026-07-10 | Cloud duplicate-safe recovery | reviewed head `f9c9df6`; merged `065967a` | isolated cloud worktree + standard Alpha9 read-only Dokploy APIs + independent fresh archive | webhook 30/30; scripts 30/30; typecheck; both builds; syntax; Compose config; diff/credential checks; `project.all` + `previewDeployment.all` across 12 applications; adversarial marker/runtime/domain/token review | pass / code only | PR #63 merged and #62 closed. Status is observational; wrong-lane tasks fail before launch; durable `unit:slug` claims, unique exact markers, standard route inventory, exact running container/labels/domain, and positive-token/negative-token MCP proof fail closed. No deployment, route, duplicate cleanup, secret, Stripe, or OpenRouter mutation occurred. |
| 2026-07-10 | Epic 3.2 post-#792 dependency acceptance | PR #791 head `121e26f` | fresh detached `/tmp/epic32-acceptance-121e26f.OO6YdV`; GitHub CI/publish evidence | CI; root build; focused joint-proof/migration 22/22; custody 12/12; artifact and source inspection | fail / correctly blocked | Publish run 29070339401 probes authenticated `/api/health` and pushed no image; full mode permits unknown commit and no digest; custody receipts omit explicit DB/WAL/SHM paths; no fresh full browser/self-host/migration package exists. #738 remains outside P0/Gate 1/Gate 2 and no retirement is authorized. |
| 2026-07-10 | Epic 3.2 exact-head image/evidence-contract re-audit | PR #791 head `b57fde0` | fresh detached `/tmp/epic32-acceptance-b57fde0.dFrU3P`; GitHub CI/publish; post-push OCI inspection | build; focused joint-proof/migration 23; custody 12; source/artifact inspection; publish run 29070914225 | partial pass / code readiness fail | Image index `sha256:28a1ad713caf4ad6678da42d32f9f735b8903baaf536d160592f709940de6f8f` exists and post-push revision matches. Commit/digest prerequisites and custody path receipts are implemented. Missing pre-push OCI-label inspection and focused enforcement/receipt/summary tests remain; full mode and both resource approvals remain unexecuted. No Gate 2 or retirement authority. |
| 2026-07-10 | Epic 3.2 closure-delta acceptance | PR #791 head `e3a264b` | fresh detached `/tmp/epic32-closure-e3a264b.wkNMdj`; GitHub CI/publish; pre/post-push OCI inspection | focused 15/15; syntax/static checks; CI 29071143424; publish/smoke 29071254538 | pass / code ready | Smoke image carries and verifies exact OCI revision before run/push; public/product/UI/negative smoke passes. Complete 96-path DB/WAL/SHM zero-match receipts, missing-path rejection, injected-secret rejection, and retained commit/digest summaries are exercised. Immutable index `sha256:98e3ae1b4a3b9d8b7bbd47624379a9d1fd70cd98f2fe80c5b1d5017e02546683`. Full mode and both resource approvals remain unexecuted; no Gate 2 or retirement authority. |
...
### 2026-07-10 - Delivery Manager - Live-wave packages merged; execution remains migration-gated

Context: the endpoint blocker was corrected from a route-deployment task to the actual architecture dependency. Epic 3.2 is still in its pilot and has not reached accepted Z-MT-6 Gate 2; Epic 3.3 and Epic 3.5 remain draft behind that pilot. Alpha9 has no canonical multi-tenant Callisthenes or Ring runtime, and the recreated `zenod-z2` still awaits provisioning without a control-plane token. Hooke, Pasteur, and Meitner prepared exact fail-closed DX-3, DX-4, and DX-5 packages in separate worktrees; combined validation passed and PR #787 merged them as `7403d0c`.
Next: child-epic owners produce the accepted migration, token-continuity, isolation, rollback, and fresh-inventory receipts named in #728/#729/#730. The steward then binds each exact manifest digest and execution window to Jordi's approval before any apply path is introduced or run. Keep cloud `TENANT_PROVISIONING_MODE=tenants_api` off until the real unit runtimes and control-plane tokens exist and cloud-test proves one Stripe TEST checkout per unit.
Risks: the remaining Zenod row is live-paying; the Callisthenes and Ring rows are still classified `unknown`; the shared canonical Epaminon row is not a tenant-retirement target. Treating HTTP route availability as migration acceptance would risk customer data and token continuity. No production mutation occurred in this package round.
Assignment identity: Epic 3.7 delivery manager integration
Branch / latest commit: `main` / `7403d0c520c8748e8a8d3cb6ee9923fbc2146d07`
Last verified: 2026-07-10 05:13 CEST
Links:

- https://github.com/zenod-ai/zenod/pull/787
- https://github.com/zenod-ai/zenod/issues/728
- https://github.com/zenod-ai/zenod/issues/729
- https://github.com/zenod-ai/zenod/issues/730
- https://github.com/zenod-ai/zenod/issues/745
- https://github.com/zenod-ai/zenod/issues/731

### 2026-07-10 - Delivery Manager - Pilot rejected; classifications resolved; recovery regression dispatched

Context: independent testing audited Epic 3.2 definitive branch `3688410` at product `2d8509e`. Its automated suites are green, but the retained contract-mode evidence does not satisfy #736 or #738: chassis vault custody leaks a synthetic world credential to WAL (#789), full per-tenant commit/marker receipts are absent, browser Repo/Ingest/Usage and self-host ingest parity are incomplete, and migration lacks the complete verify/idempotency/rollback/full-prefix/Z-5 restore set. The Epic 3.2 steward accepted the failure and withheld every cutover gate. A separate read-only correlation resolved the retained Callisthenes and Ring rows as Stripe TEST; Ring's Epaminon executor is suite-bundled. That probe was followed by a new record-only Callisthenes duplicate, so #793 and cloud #62 were minted and dispatched.
Next: merge and independently verify #789; integrate #793 and cloud #62; then Epic 3.2 rebases #791 to exact main, publishes an immutable image, and runs fresh full mode. Only after accepted #736 may #738 enter P0. Gate 2 and the separate DX-3 human gate remain later.
Risks: duplicate Traefik ownership routed a cloud-test status GET to live; deployed `status-reconcile` directly minted a duplicate and hostname-only health produced false success. Existing production inference keys are excluded from pilot testing. A capped test key and proof commits to three existing disposable repos require Jordi's narrow approval after #789/rebase. No cleanup, mode, secret, DNS, or retirement mutation was authorized by the steward in this round.
Assignment identity: Epic 3.7 delivery manager + independent acceptance/classification agents
Branch / latest commit: Zenod main `6f16985`; Epic 3.2 draft PR #791 `3688410`; cloud main `3e80e7b`
Last verified: 2026-07-10 05:38 CEST
Links:

- https://github.com/zenod-ai/zenod/issues/728
- https://github.com/zenod-ai/zenod/issues/736
- https://github.com/zenod-ai/zenod/issues/738
- https://github.com/zenod-ai/zenod/issues/789
- https://github.com/zenod-ai/zenod/pull/791
- https://github.com/zenod-ai/zenod/issues/793
- https://github.com/zenod-ai/cloud/issues/62

### 2026-07-10 - Delivery Manager - Recovery merged; post-custody pilot still rejected

Context: PR #795 merged the refreshed fleet classification and closed #793. Cloud #62 then went through three independent fail-closed review loops: lane and cross-process identity, standard Dokploy route/runtime compatibility, and unique checkout-marker ownership. Exact head `f9c9df6` passed the steward's full suite, a standard read-only Alpha9 API walk, and a fresh independent adversarial matrix; cloud PR #63 merged as `065967a` and #62 closed. No deployment or cleanup followed. In parallel, Avicenna rejected Epic 3.2 heads `121e26f` and `b57fde0`, then passed closure delta `e3a264b`: the exact image publishes, pre/post-push OCI revisions match, commit/digest identity is retained, and focused tests execute complete/missing/injected custody cases. No fresh full acceptance package exists.
Next: Jordi provides the two narrow resource approvals for exact head `e3a264b`, then Epic 3.2 runs and independently validates fresh full mode. Only accepted #736 permits #738 P0. Separately, the cloud route correction and DX-2C classified-row cleanup each need their own exact operator packet and Jordi approval; neither is authorized by PR #63, the pilot resource gate, or this reconciliation.
Risks: the duplicate record and duplicate route ownership still exist until separately approved operator actions. Cloud `TENANT_PROVISIONING_MODE=tenants_api` remains off. No P0/Gate 1/Gate 2, live migration, duplicate cleanup, route change, secret mint, or retirement action occurred.
Assignment identity: Epic 3.7 delivery manager + Huygens/Hume/Avicenna
Branch / latest commits: Zenod main `d3137a5`; Epic 3.2 draft PR #791 `e3a264b`; cloud main `065967a`
Last verified: 2026-07-10 07:25 CEST
Links:

- https://github.com/zenod-ai/zenod/pull/795
- https://github.com/zenod-ai/cloud/pull/63
- https://github.com/zenod-ai/cloud/issues/62
- https://github.com/zenod-ai/zenod/issues/728#issuecomment-4932172756
- https://github.com/zenod-ai/zenod/issues/736#issuecomment-4932172757
- https://github.com/zenod-ai/zenod/issues/738#issuecomment-4932172759
- https://github.com/zenod-ai/zenod/pull/791
...
- DX-1's one live-paying row remains `zenod-jordi-f2c7a6`. The retained Callisthenes and Ring rows are evidence-backed Stripe TEST, with Ring's Epaminon executor classified `suite-bundled`. New record-only duplicate `Us9aDVdhvlObXLDfDwW0I` is included in the merged #793 refresh but remains unapproved for cleanup. Cloud #62 prevents the observed duplicate class in code; it does not remove the existing record. Owner: Epic 3.7 steward/operator. Needed by: next test-row approval and later waves.
- After PR #791 publishes an exact immutable image and closes the remaining evidence P1s, Jordi must narrowly approve minting one capped test-only OpenRouter inference key and writing proof commits to `AlfaBlok/test_evals`, `AlfaBlok/react_test1`, and `AlfaBlok/zenod-cloud-test-vault-4ptjqj`. This is not production migration or retirement approval. Owner: Jordi. Needed by: #736 fresh full-mode acceptance.
- Cloud main `065967a` includes #745's fail-closed client, #756's product/topology queue hardening, #773's guarded watchdog deregistration CLI, and #62's duplicate-safe recovery; generic C3 provisioning is on Zenod main. The 2026-07-10 public probe still found Zenod `/api/tenants` deployed and auth-gated at HTTP 401, while Callisthenes and Ring returned HTTP 404. The blocker is the child cutover architecture, not only route deployment: 3.2 is not at Z-MT-6, 3.3/3.5 are draft, Alpha9 has no canonical multi-tenant Callisthenes/Ring runtime, and `zenod-z2` lacks a control-plane token. Owner: Epic 3.2/3.3/3.4/3.5 workers plus cloud operator. Needed by: DX-8 enablement and DX-6 cleanup.
...
| 2026-07-10 | `docs/EPIC-3.4-RING-MULTITENANT.md` | Finish and deploy Epic 3.4 after the parent pilot, prove the Ring runtime and token continuity, then notify this spine; preserve Ring-as-unit semantics while suite composition remains separate. | public HTTP 404 probe; independent architecture review; Alpha9 topology audit | Epic 3.4 worker | proposed |
