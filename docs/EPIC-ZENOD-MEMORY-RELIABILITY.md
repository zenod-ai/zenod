...
Last reconciled commit: 411aba520a7a901f82d56394d5ebf4bb89769b86; reviewed961793 tree deployed, Luna configured, original live recovery running
...
Current delivery manager/steward: ZMR-reconciliation-delivery-manager (/root). M2 dependable basics is active under #1313. M1 storage/retry proof is retained, but later production conversation failures prevent a general reliability claim. See Current State, the M2 contract and prompt/tool slide. Earlier bindings below are historical.
...
September 13 authority: Jordi approved the target flow and requested creation of its backlog, including production deployment and testing. Jordi subsequently instructed “ok implement” and “use subagents remain the delivery manager for me”; implementation, integration, bounded production deployment and testing are authorized. Deployment/testing belongs to the planned bounded release scope once exact candidate, recovery and target prerequisites pass. Earlier authorizations persist; do not repeat permission requests for unchanged approved scope. The later explicit Luna organizing request supersedes the original model freeze. Historical bulk repair, billing/signup and unrelated channel changes remain excluded.
...
Next action: hold this release stable and observe ordinary use. Treat repetitive source/history excerpts in B10–B12 as a bounded presentation follow-up. Keep ASR/WhatsApp delivery, B05 production fault injection and the 30 unrun production cells outside this completed basic-memory milestone unless a new measured incident justifies reopening it.
...
### M1 checkpoint before the M2 conversation acceptance

Phase: bounded M1 complete and deployed on Luna, with genuine filing review and documented follow-ups; broader ZMR SHIP remains open.
Last verified: 2026-09-15 Europe/Paris.
Integration target: main411aba520a7a901f82d56394d5ebf4bb89769b86 (PR1311), identical tree to reviewed/deployed961793e2f81a5ba6c9fa72636d0e3a6ff1592c5a. CI34934705483 and publication34934745173 passed. Exact live image digest2e9d44a65677666ba8ee190e949b5eab4dcbc96c4bc75856a332268000bb1ce1; OCI, baked/runtime SHA, health, mounts and environment verified.
Active owner: /root, sole deployment operator and spine steward. Ticket assistants implement/review bounded fixes and prepare read-only recovery; root retains dispatch.
Next action: hand off the working M1 result and retained follow-ups. No additional implementation, retry, provider experiment or deployment is needed for this bounded milestone. Remaining personal creator and travel-life reflections require genuine destination clarification.
Acceptance boundary: user-authorized organizer model_classify=openai/gpt-5.6-luna and model_classify_reasoning_effort=low are live. Existing OpenRouter key/provider, Grok4.3 ask and all other settings retained. No provider benchmark gate, new service, bulk refiling, sibling deployment, billing/signup or outbound messages. Existing deployment/testing authority persists.
Initial live evidence, before the selective retry: original recovery job aaf75c90-0c48-4cdb-9ef9-bca01d0ae9c1 is DONE with12filed13uncertain5pending; brain revision8f9d50d6eaa14c7abd98f16a22774a6f91fc8e99. Full original source equals the frozen input byte-for-byte. Corrected hypothetical exit math including paid interest, home requirements and location coverage are present. Financing alternatives and qualifications are retained in sourced unresolved reports; not all eleven conflict labels prove actual contradictions, and some reports overlap. Five pending include creator source_support_invalid, three context-budget failures and one clarification. Salary urgency occurs in an assigned span but is omitted from its persisted statement; retain this explicit limitation.
Ordinary summary: post-filing chat1ea57c22-d477-4a30-8058-834eab0f0dbe passed with no pinned source: selected the original September14 voice note, read actual contiguous spans14–8014–16014–17321 at one version, and returned a cited housing/life/creator summary distinguishing uncertainty from decisions. The earlier chat63d80767-be40-440f-a185-23774df80ae8 ran during filing and honestly reported busy; it is not passing summary evidence.
Recovery: protected recovery-accounted-20260915 records fresh827file/12JSON/69SQLite restore proof, offhost archive48f7226e046ff8c50e836c1c40f59ba5550799a416338e5f4635ec86226b4fd7, exact deployment and organizer configuration receipts. A stalled read-only SSH check was terminated and the missing redeploy completed under the original reviewed intent; no duplicate deployment or data restore. See evidence/zmr-live-a43f7ee/README.md. Latest terminal selective retry:15filed13uncertain2pending at f522887e9f129cf602cd809590facc9b326bf764; remote publication verified. Three context-budget pending ideas now filed. Both remaining pending reasons are reconciliation_needs_clarification; no technical source-support/context-budget failures remain. Private before/after comparator passes all13checks with all27 prior completed operations, bullet/citation bytes, raw evidence, original job/capture rows and legacy lines retained. Independent semantic/preservation reviewer accepts bounded M1 with explicit follow-ups: salary urgency and specific Taya visit detail are absent from meaning prose, some unresolved reports overlap, and two destinations require clarification. These limits remain in raw evidence/review; no exhaustive sentence-level filing claim.
...
Execution status: capture repair #1316 frozen/reviewed `66d6a5f`, 136 engine tests pass. Harness parity patch #1313 `9a671b2` independently approved with24 focused tests, unchanged fixture/rubric. Root launched actual-model candidate capture checks B01/B04 ×3 in private `capture-candidate-1`, $0.30/60-request cap, same Luna(low)/Grok models. This reserves at most $0.30 from remaining $0.63407853 of the original $1 aggregate allowance; no concurrent paid run is authorized. All36 denominator rows remain visible. No M2 deployment.
Waiting on: measured capture-candidate outcomes and independent semantic review. #1318 answer repair runs locally in parallel, grounded in B06/B10 failures. No human permission wait.
Approved work: systematic M2 improvement through exact-version production acceptance using existing models/services. Concurrent production-opening changes must be preserved.
Next action: review capture outcomes; integrate independently reviewed answer repair; run the unchanged full suite and production acceptance with explicit cumulative costs. Do not claim local tests or partial batches as M2 acceptance.
...
[#1320](https://github.com/zenod-ai/zenod/issues/1320): production acceptance adapter using existing tenant lifecycle. Owner /root/zmr12_worker; dedicated codex/zmr-m2-production-tests from b054fb5. No worker provisioning/deployment/paid calls. Avoid shared-vault resets and ignored branch setting; exact disposable synthetic ownership and cleanup manifest required. Root owns actual production execution.

[#1318](https://github.com/zenod-ai/zenod/issues/1318): measured B06/B10 answer repair. Owner /root/release_preflight; dedicated codex/zmr-m2-answers from reviewed66d6a5f. Extend existing summary/answer support contract, preserve guards and frozen scenarios; no worker paid calls/deployment. Root owns independent review and exact-candidate acceptance.

[#1316](https://github.com/zenod-ai/zenod/issues/1316): measured B01 repair, single conversational capture and truthful durable receipt. EXTEND captureEvidence/enrichEvidence + existing TaskJobQueue. Owner /root/release_preflight; branch codex/zmr-m2-capture, worktree ../wt-zmr-m2-capture, base2a4ff6623fc6efa48355c5e697dd38c9c4833f67.90minute checkpoint. No worker deployment; root integrates preserving production-opening changes.
...
[ZMR-M1 #1310](https://github.com/zenod-ai/zenod/issues/1310): CLOSED/completed. PR1311 merged as411aba520a7a901f82d56394d5ebf4bb89769b86; reviewed961793e2f81a5ba6c9fa72636d0e3a6ff1592c5a deployed with Luna/low. Independent bounded M1 acceptance passed: full-source ordinary summary, useful qualified filing, one selective retry preserving27 prior operations and all13 invariants. Two genuine destination clarifications remain; salary/Taya prose omissions and compactness are explicit follow-ups. No further implementation or deployment queued. [Final handoff](https://github.com/zenod-ai/zenod/issues/1310#issuecomment-5676430042). Detailed historical failures remain in the evidence journal and Git history.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| [ZMR-36 #1296](https://github.com/zenod-ai/zenod/issues/1296) | repair K | BUILD output budget | 90 min checkpoint | Ticket worker | /root/zmr12_worker | Bound low classifier and reconciliation output | PR1303 reviewed; CI running | ZMR-34, ZMR-35 | /Users/jordi/Documents/GitHub/wt-zmr-36-classify-budget | codex/zmr-36-classify-budget | c19eec1 | 15d249;17 tests;ASR classification complete9508tokens | 2026-09-15 | Integrate; retain semantic gate |
| [ZMR-35 #1295](https://github.com/zenod-ai/zenod/issues/1295) | repair J | BUILD answer support | 90 min checkpoint | Ticket worker | /root/zmr12_worker | Read discovered sources before supported answers | integrated PR1302; acceptance ongoing | ZMR-33 | /Users/jordi/Documents/GitHub/wt-zmr-35-discovery | PR1301 via PR1302 | 10019d8 | e96f3a9;177 tests;text18/18 | 2026-09-15 | Retain in final candidate |
| [ZMR-38 #1306](https://github.com/zenod-ai/zenod/issues/1306) | repair L | BUILD bounded raw discovery | 90 min checkpoint | Ticket worker | /root/zmr_acceptance_design | Discover pending topics through original evidence | reviewed and merged PR1307 | ZMR-37 | /Users/jordi/Documents/GitHub/wt-zmr-38-pending-discovery | codex/zmr-38-pending-discovery | 6f21a43c8ed2b15d4c9e281f346b49c7fe76bf66 | English query misses Spanish raw; matching pending label excluded with receipt | 2026-09-15 | Curated discovery only; raw read still required |
| [ZMR-37 #1304](https://github.com/zenod-ai/zenod/issues/1304) | repair L | BUILD atomic operation groups | 90 min checkpoint | Ticket worker | /root/zmr12_worker | Preserve new clauses in coarse classified ideas | reviewed and merged PR1305 | ZMR-36 | /Users/jordi/Documents/GitHub/wt-zmr-37-operation-groups | codex/zmr-37-operation-groups | 15d249e21ef579fc3078325afeee386e24ff4dc5 | Measured rain-condition loss; reviewed group design | 2026-09-15 | Implement, independently review, actual acceptance |
| [ZMR-34 #1294](https://github.com/zenod-ai/zenod/issues/1294) | repair J | BUILD bounded validation | 90 min checkpoint | Ticket worker | /root/release_preflight | Validate source addresses and assigned coverage | integrated PR1302; acceptance ongoing | ZMR-33 | /Users/jordi/Documents/GitHub/wt-zmr-34-coverage | codex/zmr-34-coverage | 10019d8 | 14ef939 reviewed;136 tests; text10/10 | 2026-09-15 | Retain in final candidate |
...
| [ZMR-27 #1278](https://github.com/zenod-ai/zenod/issues/1278) | repair E | BUILD bounded evidence delivery | 90 min checkpoint | Ticket worker | /root/zmr12_worker | Substantive read packets and exact support choices | ready | completed low regression | /Users/jordi/Documents/GitHub/wt-zmr-27 | codex/zmr-27 | this control-plane commit | 2/18 complete answers; small-page blank/header reads | 2026-09-14 | Implement; independent review; unchanged acceptance |
| [ZMR-28 #1279](https://github.com/zenod-ai/zenod/issues/1279) | repair E | BUILD existing organizer contracts | 90 min checkpoint | Ticket worker | /root/zmr11_worker | Bounded output and branch relevance | ready | completed low regression | /Users/jordi/Documents/GitHub/wt-zmr-28 | codex/zmr-28 | this control-plane commit | 3/10 filing; output starvation and wrong destination | 2026-09-14 | Implement; independent review; bounded actual-model probe |
...
| [ZMR-33 #1292](https://github.com/zenod-ai/zenod/issues/1292) | repair I | FIX voice semantic units | bounded atomicity repair | Ticket worker | /root/release_preflight | Independent propositions and comparable numeric guard | ready | 66f84 real ASR | /Users/jordi/Documents/GitHub/wt-zmr-33 | codex/zmr-33 | 66f84a9715ee321c2388c34baad1881513c6b119 | Grouped garden ideas; spelled legacy date | 2026-09-15 | Review and actual ASR acceptance without weakened source checks |
...
### Offline contract integration receipt — 2026-09-14

ZMR-24 PR #1273 is reviewed and merged; ZMR-25 PR #1272 is reviewed and merged after successful CI rerun on its unchanged exact head. The ZMR-15 terminal-provider safeguard PR #1271 is reviewed and merged. Exact worker heads and combined build/107 focused product tests/18 harness tests/27 schemas are recorded in [the evidence receipt](evidence/zmr-reconciliation-2026-09-13/README.md#offline-contract-repairs-after-the-quota-interruption). Independent review fixed the source statement round-trip cap and final-round mixed-chat submission before approval. No additional paid calls, ASR or deployment occurred.
...
### September 14 resumed delivery after completed DeepSeek low regression
...
### Bounded evaluator deadline repair under ZMR-15

Combined reviewed product candidate d17a3db was stopped after its first request remained unresolved beyond the existing cooperative120s timeout. One unknown reservation$0.022660125 is retained; no semantic outcome was measured. Parent assigned /root/zmr11_worker to existing ZMR15 #1241, dedicated codex/zmr-15-deadline worktree from d17a3db, to enforce a hard whole-response deadline, terminal no-retry latch and durable incomplete receipt. Frozen candidate remains untouched. No new service or product timeout changes. A separate exact-request Python transport probe completed in57.16s with validJSON/862output/zero reasoning, cost$0.0024861; different provider means this does not prove a Node-specific cause. Next evaluation may prefer IPv4 on the operator laptop, recorded as environment choice; source/model/acceptance remain unchanged.

ZMR27 full CI revealed legacy fake-answer consumers of the internal single-section response; the worker updates those test adapters to verify all packet sections while retaining content/provenance assertions. This is not a relaxation of held-out model acceptance. Production unchanged; keys available; no human wait.


The bounded d17/f41 IPv4 run terminated correctly at a120s Taller reconciliation deadline; 0 recalls/replay measured. Aula operations persisted, but its current correction string was subjectless ('será el19deoctubre') despite complete source/history metadata. Parent binds ZMR29 to improve explicit organizer-only OpenRouter provider routing and use complete correction reports through existing contracts. Same model and budgets; no priority-tier variant, silent model fallback, newservice or acceptance weakening. Provider selection is configuration work within the approved organizing-model switch. Production remains unchanged; deploy authorization persists.

### 2026-09-15 — ZMR-34 assigned-coverage follow-up

Combined reviewed33–36 integrated through PR1300 at2c6c498a75cb0ff3b9bd37d5ac705ebf34036678 after greenCI. Exact non-doc source equals tested10019; merged/image-built is not deployed. Low reasoning/together-first text and bothASR attempts hit provider120s deadlines. Alternate modal,together text completed filing but third classification window omitted a real tail idea while declaring every passage assigned; source was present in the prompt. Spanish alternate run likewise claimed all3passages assigned with empty source assignments, producing no new organized knowledge. Host preserved raw and rejected unsupported writes. English alternate held to avoid spending on the same known defect.

Existing ZMR-34 #1294 scope is extended narrowly: within the SAME classifier validation/retry callback, require an assigned passage review to have actual validated owned topic support. Reuse host range/ownership rules; do not infer missing meaning or reassign quotes. Preserve legitimate neighboring context and final pending outcomes; no added loop. Owner /root/release_preflight, dedicated codex/zmr-34-coverage worktree from10019. Root remains sole steward. Actual acceptance must repeat after review.

### 2026-09-15 — ZMR-35 discovery/read boundary follow-up

Actual10019 alternate-route empty recalls terminated at rounds2and3of8 after search found the right meaning page but before any passage read. Search automatically loaded unrelated date fact projections, exposing support IDs and enabling premature submission. Qualification recall similarly selected an unrelated date candidate without reading the requested hypothesis page.

Existing ZMR-35 #1295 owner/root/zmr12_worker is bound to a dedicated codex/zmr-35-discovery worktree from10019. Remove the search-only automatic fact projection hook in memoryAnswerSession; retain verified temporal projection on actual read_note and explicit read_facts, plus pinned/typed-entry evidence paths. Restore discovery→read→submit without a new loop, service, relevance judge or higher model-round budget. Require meaningful tests of search without claim support and subsequent explicit read with canonical source/history guarantees. Root alone stewards and repeats actual acceptance after independent review.

### 2026-09-15 — Frozen coverage/discovery acceptance candidate

Reviewed source candidate `c19eec1436ebf5c9b2cae613cb530fee7338770f` combines assigned-passage coverage validation (`14ef939`), discovery/read boundary (`1399341`) and public test traversal correction (`e96f3a9`). Existing retry/round budgets and canonical temporal assertions remain unchanged. Product workers report 136 coverage/engine tests and 177 discovery/engine/public tests, with independent root source review and 52 focused tests. PR1302 integrates the same non-doc tree onto current main; candidate image run34908484196 is building, neither constitutes deployed proof.

Root launched bounded actual text acceptance in private `candidate-deepseek-coverage-discovery`, DeepSeek V4.1 Flash with existing low effort and modal,together routing, $0.80/80-request cap. Sequential Spanish then English actual ASR follows text filing, avoiding concurrent organizing bursts. Production remains631f851 and owner settings remain unchanged. No human/key approval wait exists. Architecture audit found classifier temporal metadata still consumed via a fragile matching bridge; defer simplification rather than silently removing dates/verification during release repair. Next: exact semantic acceptance, fresh verified recovery, deploy exact image, isolated live acceptance, owner-only configuration and single original VN recovery.

C19eec text regression completed with independent review:10/10meaning,18/18answers48/48subclaims,byte-identical replay and archive verification; reportedcost$0.248547,unknown0. PR1302 merged57168d3ce82ca9463159de21fbbbe5f18872ef47 after CI34908504151success. Candidateimage `ghcr.io/zenod-ai/zenod@sha256:4136c232dd27632693a807ab651b5fc2d45fe09a176076e7a9d1978e5954ae97` OCIrevisionexactc19eec, publish34908484196success.

Spanish actualASR low/modal,together exhausted8192output on both classifier attempts, with6000reasoning tokens on first; therefore low configuration not accepted. English low held before dispatch. Root authorizes separate same-candidate ES then EN none/modal,together evaluation with unchanged fixtures and per-run$0.50/40caps, English contingent on Spanish semantic review. No source or live configuration change. Owner setter preparation remains unapplied; exact desired setting must match eventual accepted configuration. Production healthy631f851, queuesempty in fresh23:29UTCread-onlypreflight.

### 2026-09-15 — ZMR-36 classifier output exhaustion follow-up

ESnone/c19eec completed classification but collapsed new rain condition and unknown pump cost into source reinforcement, losing those distinctions. No ENnone or textnone run is authorized on that failed outcome. ESlow first partial response contains confident atomic ideas, but6000reasoning tokens leave inadequate JSON space at8192; second attempt also truncates, later repair yields zero confidences. Root binds/root/zmr12_worker to existing ZMR-36#1296, new dedicated worktree fromc19eec, to raise only LOW classifier output ceiling to16384. Low reconciliation8192,none/default/ask budgets,120sdeadline and request counts remain unchanged; no extra service/call/setting. Worst-case incremental reservation at reviewed$1.50/M output is$0.012288per affected classifier request. Root will create a separate conservative pricing artifact rather than altering past evidence. Require request-option tests and independent review; then ESfirst actualacceptance. This responds to measured truncation rather than relaxing semantic acceptance.

### 2026-09-15 — ZMR-37 atomic operation groups

15d249 low classifier16384 completes9508outputtokens; budget repair works. Spanish filing preserves pumpcost but still loses new rain procedure behind LINK_SOURCE;7/9answers and custody/replayPASS, semanticFAIL. EN/text held. Code review identifies one-decision-per-idea validation as an unnecessary hard dependency on perfect classifier granularity. Root binds ZMR-37#1304 to/root/zmr12_worker, dedicatedcodex/zmr-37-operation-groups from15d249, to allow bounded source-native operation groups with all-or-nothing validation per connected shared-idea group. Existing page receipt/publication/completed-idea guards remain. Prompts compare each independently maintainable proposition; provenance does not alone prove semantic completeness. No additional modelcall/service/journal. Root alone reviews/integrates; tester repeats exact accepted cases only after review.

ZMR37 exact6f21a43c8ed2b15d4c9e281f346b49c7fe76bf66 independently approved after duplicate effect and replacement/correction compatibility fixes. Root69tests and reviewer72testsPASS; workeractualqueue5 and fullmonobuildPASS; fullengine regression running. Group buffers roll back edits/proposals/effects/applied IDs together; exactduplicateeffects renderonce while completingbothidea outcomes; same-target resources join groups; conflicts remain distinct. Rootreleased ESactual6f21a43low/modal,together with16384priceartifact and unchanged$.50/40/120s. Source acceptance stillpending; production631f851 unchanged. PR1303 mergedf524fb;15d imageverifieddb993031a324f585d5b8b5bbef4390954820fcb965dbfbd1871d246a210ff891 but supersededforacceptance by37.

### 2026-09-15 — ZMR-38 pending-topic retrieval

Independent15d recalltrace identifies exactcross-language gap: Englishlibraryqueriesfindnothing because the English pending-topic label exists only in an excluded filingreceipt; Spanishrawtextdoesnotmatch Englishlexicalquery. Twofailedtrials readonlyunrelatedCookingthenempty; successfulthirdreadsLogandselectsverifiedrawhandles. Rootbinds ZMR38#1306 to/root/zmr_acceptance_design, dedicatedworktreefrom6f21a43, for bounded host-curated pendingtopic→originalrawref discovery through existingsearch. InternalreceiptJSON stays non-evidence; no automaticfacts/supporthandles, newmodelcall or storageindex. Validate existingreceiptshape/sourceidentity/malformedorstalepointers andtenantbounds; actualreadsuppliessupport. FullEnglish/textacceptance waits integratedfinalcandidate; ongoingES37trial measuresfilingonly untilcomplete.

### September 15 delivery reset and durable handoff

Jordi explicitly separates model performance experiments from production delivery: retain existing MiniMaxM3 configuration, finish reviewed37+38, deploy and verify existing production flow. No further provider tests are a release prerequisite. Root records delivery failure and complete findings in [the durable handoff](planning/zenod-memory-upgrade-handoff-2026-09-15.md). At checkpoint00:00UTC, production remains631f851,37mergeddb3fbbd,38revieweda43f7ee/integration29226aa awaitingCI/image. Backup/deploy/originaljob recovery notyetperformed.

### User-requested pause and final restart checkpoint

Work is paused after Jordi requested a complete note so it can be picked up later. The linked durable handoff contains investigation findings, failed and passing experiments, costs, code identities, operator paths and the restart plan. Final a43f7ee image is published and OCI verified; PR1307 CI was still running at handoff. Production remains unchanged; no fresh backup, deployment or original-job recovery was performed. Refresh remote status and operational snapshots on resume. Retain MiniMax and keep provider research separate.

### September 15 production rollout

Final CI and review passed; PR1307 merged88d38566. Backup restore verified812files/69SQLite databases at00:15:49UTC; independent1.4GB archive checksum passed. Exacta43 image dispatched once. Same service retained its ID; scale-zero rollout leaves UpdateStatus null. Original helper polling stopped only after independent20-check exact task/OCI/health/env/mount/app verification and empty queue; deploy-verified.json records this direct method. No redispatch. Initial suggestion of service recreation was disproved and corrected. ModelDB confirms MiniMax M3, Grok4.3, absent organizer effort/provider overrides.

Original recovery helper needed one independently reviewed compatibility repair: accept the exact historical Drive suffix ?usp=drivesdk while preserving fixedcaptureSHA/fullmatch;14tests pass. Quiescence task inspection encountered a removed-task race, then fresh full task/volume checks confirmed no writers. One CAS committed; original input/capture/result identity and rawentry checked before change. Service restored; existing authenticated owner settings GET resumed runtime. Hosted settings intentionally omit model fields; internal HTTPjob route is forbidden, so exact status uses supported MCP. Worker confirmed running.

### September 15 live acceptance failure and bounded repair

Original job completed at revisionc084de9e with0filed/11uncertain. Postcheck proves original input and archive/raw custody unchanged; resultSHA360a63bb5b948d1d1f9f3346b5d816b4d5688f5c9510257c20dceb39eb5ea4c5. Firstwindow model summary explicitly interpreted already-captured caller hint as reason to skip substantive routing; remaining clear housing topics asked between overlapping known pages. Natural latestVNsummary correlationtest_2843b0335cae4fb68128fd0378a66094 selectedSep6 rather thanSep14; direct-source ask returned chopped quotations rather than requestedsummary. These are failedlivechecks, not success.

Bind sole ZMR17 worker/root/zmr_acceptance_design, dedicatedcodex/zmr17-live-contract-repair froma43, reviewer/root/zmr12_worker. Repair ambiguous stage2hint, missingtopic-sourcevalidation retry, supportednarrowest-scope routing instructions, stale exactly-one-operation schema description, category-first recency references/whole-source reading contract, and optional citedraw-summarytext preserving existingfact/temporal guards. No added modelcall/service or hostforced destination/confidence. Sourcequotation and citations cannot deterministically prove model-authored summary entailment; preserve qualifications and test honestly. Root prepares fresh recovery while author works.

### September 16 M2 measured capture repair

Exact66d6a5f with harness9a671b2 independently passes B01/B04 three trials each (6 selected PASS;30 other trials unmeasured). Every original is byte-identical, one raw anchor/one completed job; all qualified topics filed. Three capture calls in B04:3 still produce one original/job. Actual cost $0.06352236, unknown0. Versioned receipts and the second HTML slide are in docs/evidence/m2-basics and docs/planning/zenod-basics-test-results.html. PR1319 is patch-equivalent to reviewed66d; CI pending, no deployment.

Baseline-4 attempted B11/B12 with $0.15 cap, but conservative whole-request reservation stopped before any answer despite actual setup cost only $0.00202629. Original incomplete attempt retained. Root explicitly dispatched baseline-5 same2a4/fixture with $0.50/40request cap, only B11:1/B12:1, within aggregate remaining $0.56852988. No concurrent paid runs. This is not an answer-failure reroll. Baseline-5 reviews pending.

### September16 combined answer candidate and live-base preservation

Capture/harness PRs1319/1317 merged after CI passed, main d76b708. Answer fix d6f052d independently approved with focused source-boundary/assessment tests; PR1321 integrates its identical patch onto main. Root targeted answer-candidate-1 stopped on conservative source-context reservation before an answer ($0.02442628), not a semantic failure. Root explicitly authorized new bounded answer-candidate-2 at $1/60requests with identical d6/source/fixture/models; prior cost retained ($0.49345477 completed before this run). Original aggregate baseline allowance is not silently treated as renewed; this is an additional explicit candidate validation allowance.

Read-only production preflight at02:28UTC found newer dcc5ef2 (auth/MCP work), actual task/image/OCI/health agree and service mount preserved. Root integrated reviewed capture+answer patches on that live base as9db07b0f16701b22f1278c3c65d0065cb368ba73 in codex/zmr-m2-release; independent stable patch-ID and ancestry checks pass. Full release suite must test this exact integrated candidate. Superseded nondeployed image builds canceled; publish35048260188 targets9db. No M2 deployment yet.
