...
Phase: text regression passes; remaining real-voice semantic repair
Last verified: 2026-09-15 Europe/Paris
Integration target: main
Fresh base commit: 0a37af17197c22a6c53afabfa5ecded565838c4a (ZMR-31 merged). Frozen candidate108ecb13da53f300a99968e4dada7ce67e4166ba combines reviewed31/32/33 and historical-label repair. ZMR-33 independently passes106tests and typecheck; actual text and ES/EN voice regression running. ZMR-32 integration7ab5804 is tree-identical to reviewed patch on main and awaits CI.
Next action: finish actual ES/EN filing/recall and text regression on108ecb1; publish exact immutable image and reconcile31–33 integration; then fresh recovery, deployment and isolated live checks. No permission or credential wait; rollout remains authorized.
Blockers: candidate66 passed10/10 filing,18/18 answers and48/48 subclaims with byte-identical replay (cost$0.256139656). Separate real voice runs preserve audio/transcript/evidence and exact addresses; EN correction/history passes3/3, but Garden ideas are grouped and remain incomplete, and ES correction is falsely rejected because its legacy target spells the date rather than using digits. ES7/9 andEN8/9 requested-information coverage do not pass full acceptance. ZMR-33 fixes only these existing contract gaps; no source or scoring relaxation. Historic correction wording trips the public action-prose guard; reviewed da6 label fixes that without weakening guard.
Acceptance boundary: existing pipeline; approved organizer deepseek/deepseek-v4.1-flash, reasoning none, providers together,modal; ask x-ai/grok-4.3 unchanged. No new service, historical bulk refiling, Phylax deployment or outbound WhatsApp. These fixtures are development regressions after diagnosis, not untouched holdouts. Public runtime remains631f85109dfa45fed95394a1e94d2d709c373fe6; fresh backup/deployment not performed. Original single failed VN raw evidence is preserved; bounded same-job recovery plan is prepared, not executed.
...
Last attempted: actual text and Spanish/English local-ASR regression on frozen `108ecb13da53f300a99968e4dada7ce67e4166ba`, 2026-09-15 Europe/Paris; in progress.
Result: earlier `66f84a9` passed text filing10/10, answers18/18 and subclaims48/48; real ASR preserved evidence but exposed bundled ideas and Spanish word-number target comparison. Reviewed ZMR-33 repairs those contract gaps; new semantic evidence is required.
Execution status: ZMR-31 merged `0a37af1`; reviewed ZMR-32 integration `7ab5804` awaits CI; ZMR-33 `83e6470` independently passes106tests/typecheck. Combined candidate includes historical-label fix `da6dfc4` and33.
Waiting on: running candidate acceptance and exact image build, not user permission or provider quota.
Approved work: bounded implementation, integration, production deployment/testing, organizer-only DeepSeek V4.1 Flash with reasoning none and together/modal routing, and recovery of the one failed owner VN. Root remains delivery manager; no other-tenant/global switch, historical bulk repair, Phylax deployment or outbound messaging.
Next action: accept exact candidate quality and artifact, prepare verified fresh recovery/offhost copy, deploy public Zenod, run isolated live checks, apply owner organizer settings and recover the original single job. Do not claim a merge or image build is deployment.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| [ZMR-36 #1296](https://github.com/zenod-ai/zenod/issues/1296) | ticket worker | /root/zmr_acceptance_design | Bounded low-reasoning reconciliation output | active | ZMR-33 reviewed | codex/zmr-36 | 108ecb13da53f300a99968e4dada7ce67e4166ba | Existing low mode8192, none/default4000 unchanged, request tests and actual root comparison | No-reasoning reconciliation mislabels new pump-cost uncertainty as equivalent | 2026-09-15 | Implement bounded budget then measure low mode before choosing live setting |
| [ZMR-35 #1295](https://github.com/zenod-ai/zenod/issues/1295) | ticket worker | /root/zmr12_worker | Complete claim-sized answer supports | active | ZMR-33 reviewed | codex/zmr-35 | 108ecb13da53f300a99968e4dada7ce67e4166ba | Source previews, complete list items, navigation exclusion, unchanged budgets and independent actual acceptance | Text108ec filed10/10; recall16/18 with two wrong handle selections | 2026-09-15 | Implement narrow support contract repair |
| [ZMR-34 #1294](https://github.com/zenod-ai/zenod/issues/1294) | ticket worker | /root/release_preflight | Source-address validation in existing classification retry | active | ZMR-33 reviewed | codex/zmr-34 | 108ecb13da53f300a99968e4dada7ce67e4166ba | Exact addressed validation, bounded retry, safe partial outcome, independent review and actual ASR | EN108ec assignment audit: 10 wrong passage addresses safely rejected | 2026-09-15 | Reuse existing retry; no fuzzy reassignment |
