...
Phase: ZAL-7 and ZAL-8 integrated; ZAL-9 and ZAL-10 held in bounded review-fix loops
Last verified: 2026-08-25 CEST
Integration target: `main`
Fresh base commit: `dd41a9c` on `main`
Next action: review corrected exact SHAs after the bound ZAL-9 and ZAL-10 workers close every recorded blocker; integrate neither until each passes independent review and a combined version-coherent gate.
...
| [#1076](https://github.com/zenod-ai/zenod/issues/1076) | Ticket worker | ZAL-10-managed-ai-worker | ZAL-10 · Extend existing billing and metering for managed Hosted usage | running / review fixes | approved economics | [PR #1086](https://github.com/zenod-ai/zenod/pull/1086) / `codex/zal-10-managed-ai` | `fa41246` | Existing customer/billing/metering stores gain managed cap lifecycle; Hosted is percentage/state/reset only; self-host/raw operator evidence remains. | Corrected `6370b8b` closed the first ten blockers and passed CI/1,832 tests, but re-review blocked remaining Ring/Phylax/team/peer API exposure, Telegram admission-failure restart loss, and missing paused/terminal Telegram channel receipts. | 2026-08-25 CEST | Same worker closes the three exact capability/offset/receipt blockers; steward re-reviews and then runs combined ZAL-9/ZAL-10 evidence; no live key/billing mutation. |
