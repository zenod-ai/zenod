...
Phase: ZAL-7 integrated; ZAL-8 and ZAL-10 held in bounded review-fix loops
Last verified: 2026-08-25 CEST
Integration target: `main`
Fresh base commit: `fa41246` on `main`
Next action: review the corrected PR #1085 and PR #1086 SHAs after their independent-review blockers are fixed; integrate only with green version-coherent evidence, then dispatch [ZAL-9 #1075](https://github.com/zenod-ai/zenod/issues/1075) after #1074 passes.
...
| [#1074](https://github.com/zenod-ai/zenod/issues/1074) | Ticket worker | ZAL-8-direct-routing-worker | ZAL-8 · Remove Ring and repair Zenod’s existing Phylax WhatsApp route | running / review fixes | approved Zenod/Phylax boundary and 48-hour audit | [PR #1085](https://github.com/zenod-ai/zenod/pull/1085) / `codex/zal-8-direct-routing` | `fa41246` | Existing Phylax path calls Zenod directly; eight audited receipt/timeout/classifier/media/long-note/transcript/delivery/reply defects are pinned; session/data and separate Ring functionality remain intact. | Initial `0c42b84` CI/test green but review blocked false text timeout, internal copy/error leakage, transcript LIMIT isolation, and classifier-error privacy. | 2026-08-25 CEST | Worker fixes blockers and updates exact SHA/tests; steward re-reviews; no live mutation. |
...
| [#1076](https://github.com/zenod-ai/zenod/issues/1076) | Ticket worker | ZAL-10-managed-ai-worker | ZAL-10 · Extend existing billing and metering for managed Hosted usage | running / review fixes | approved economics | [PR #1086](https://github.com/zenod-ai/zenod/pull/1086) / `codex/zal-10-managed-ai` | `fa41246` | Existing customer/billing/metering stores gain managed cap lifecycle; Hosted is percentage/state/reset only; self-host/raw operator evidence remains. | Initial `5d95baf` test green but review blocked Hosted bearer scope, reset/disabled-key/provider semantics, ZAL-7 seam, real cap queue, durable concurrency, and entitlement ordering. | 2026-08-25 CEST | Worker fixes blockers, integrates latest main, and updates SHA/tests; steward re-reviews; no live key/billing mutation. |
