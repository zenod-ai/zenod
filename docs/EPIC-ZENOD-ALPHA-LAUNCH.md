...
| [#1099](https://github.com/zenod-ai/zenod/issues/1099) | Ticket worker / tester | ZAL-22-voice-drive-finalization-worker | ZAL-22 · Finalize WhatsApp voice transcription and tenant Drive archiving | review | `bbcdcd7` stability baseline | [PR #1100](https://github.com/zenod-ai/zenod/pull/1100) / `codex/voice-drive-2h-policy` | `bbcdcd7` | Up to and including two hours transcribes automatically and always archives original audio; over two hours archives without transcription and files a pointer; receipts carry archive link/status; overlapping/redelivered notes remain exactly-once; no auth/credential/session/topology change. | Local exact head `84f006d`: full repository tests, server 987/987, focused 107/107, all-workspace typecheck, build, 27 schemas and diff check pass; independent review and CI pending. | 2026-08-27 CEST | Complete independent exact-head review and CI, integrate, publish immutable image, back up both volumes, deploy signup-closed, then run live acceptance. |
