...
Last reconciled commit: `3c0d084` plus current spine working tree
...
Phase: approved 21-screen Zenod product/backend contract converted into a proposed implementation backlog
Last verified: 2026-08-25 CEST
Integration target: `main`
Fresh base commit: `6d65262` on `main`
Next action: dispatch the first dependency batch from the proposed backlog: [ZAL-7 #1073](https://github.com/zenod-ai/zenod/issues/1073) for edition-aware portal truth, [ZAL-8 #1074](https://github.com/zenod-ai/zenod/issues/1074) for direct private Phylax-to-Zenod routing, and [ZAL-11 #1077](https://github.com/zenod-ai/zenod/issues/1077) for the protected owner-admin foundation. Each remains proposed until explicitly selected under the command contract.
Blockers: no blocker to local implementation planning. Hosted deploys public Zenod plus the existing private Phylax service for WhatsApp. The supported self-host package starts one Zenod container and shows Telegram only; Phylax source and functionality remain intact for Hosted or optional advanced manual operation. Production mutation, live billing drill, signup opening, WhatsApp-session change, and external promotion remain separate later approvals.
...
| [#1073](https://github.com/zenod-ai/zenod/issues/1073) | Ticket worker | unassigned | ZAL-7 · Implement edition-aware Zenod portal shell and truthful customer surfaces | proposed | approved 21-screen contract | `codex/zal-7-edition-portal` | `6d65262` | Hosted renders exactly six customer screens; self-host renders seven and contains no WhatsApp/Phylax product copy; capability, responsive, permission, empty, and error states pass. | Binding `ui-contract.html`; issue contains full scope/acceptance/validation. | 2026-08-25 CEST | Dispatch first with fresh base when explicitly selected. |
| [#1074](https://github.com/zenod-ai/zenod/issues/1074) | Ticket worker | unassigned | ZAL-8 · Route every Zenod channel directly to Zenod through private Phylax transport | proposed | approved Zenod/Phylax boundary | `codex/zal-8-direct-routing` | `6d65262` | Text/voice/media reach Zenod directly with one truthful reply; existing Phylax runtime/session/data remain intact; Ring is absent from the Zenod phone path. | Current production audit plus issue acceptance matrix. | 2026-08-25 CEST | Dispatch in first batch when explicitly selected; no production/session mutation. |
| [#1075](https://github.com/zenod-ai/zenod/issues/1075) | Ticket worker | unassigned | ZAL-9 · Build Hosted WhatsApp activation inside Zenod Channels | proposed | #1073, #1074 | `codex/zal-9-whatsapp-activation` | `6d65262` | Hosted activates one verified sender entirely inside Zenod; self-host remains Telegram-only; typed activation states and safe mutations pass. | Binding Hosted Channels contract. | 2026-08-25 CEST | Wait for #1073 and #1074. |
| [#1076](https://github.com/zenod-ai/zenod/issues/1076) | Ticket worker | unassigned | ZAL-10 · Provision managed AI usage and customer-safe Hosted usage states | proposed | #1073, approved economics | `codex/zal-10-managed-ai` | `6d65262` | Encrypted/audited tenant model access and cap automation work; Hosted sees percentage/state/reset only; raw evidence is preserved at the cap. | Binding Usage contract and approved economics. | 2026-08-25 CEST | Wait for #1073. |
| [#1077](https://github.com/zenod-ai/zenod/issues/1077) | Ticket worker | unassigned | ZAL-11 · Build protected Zenod owner-admin foundation and setup health | proposed | #1073 shared capability foundation | `codex/zal-11-owner-admin-foundation` | `6d65262` | Single owner admin is distinct from ordinary customer identity; auth fails closed; encrypted/masked/audited setup health is concrete. | Binding owner Setup & health contract. | 2026-08-25 CEST | Dispatch in first batch when explicitly selected; coordinate shared shell ownership with #1073. |
| [#1078](https://github.com/zenod-ai/zenod/issues/1078) | Ticket worker | unassigned | ZAL-12 · Implement owner tenant lifecycle and tenant-detail operations | proposed | #1074, #1076, #1077 | `codex/zal-12-tenant-ops` | `6d65262` | Typed, confirmed, idempotent and audited tenant mutations work without deleting external GitHub/Drive data. | Binding Tenants/Tenant detail contracts. | 2026-08-25 CEST | Wait for dependencies. |
| [#1079](https://github.com/zenod-ai/zenod/issues/1079) | Ticket worker | unassigned | ZAL-13 · Add owner AI spend analytics and provider reconciliation | proposed | #1076, #1077 | `codex/zal-13-ai-analytics` | `6d65262` | Thirty-day daily spend by model/operation, including transcription, reconciles to typed ledger/provider totals with explicit freshness/drift. | Binding owner AI & usage contract. | 2026-08-25 CEST | Wait for dependencies. |
| [#1080](https://github.com/zenod-ai/zenod/issues/1080) | Ticket worker | unassigned | ZAL-14 · Add owner channel transport health and traffic telemetry | proposed | #1074, #1077 | `codex/zal-14-channel-health` | `6d65262` | WhatsApp/Telegram transport health and 1h/24h/240h traffic reconcile to events; owner personal channel state is absent. | Binding Channel health contract. | 2026-08-25 CEST | Wait for dependencies. |
| [#1081](https://github.com/zenod-ai/zenod/issues/1081) | Ticket worker | unassigned | ZAL-15 · Implement job traces, error analytics, typed retry and delivery truth | proposed | #1074, #1077 | `codex/zal-15-job-errors` | `6d65262` | Time-window/error-type analytics reconcile to job traces; retry is typed/idempotent; no duplicate or misleading customer replies. | Audit failures and binding Jobs & errors contract. | 2026-08-25 CEST | Wait for dependencies. |
| [#1082](https://github.com/zenod-ai/zenod/issues/1082) | Ticket worker | unassigned | ZAL-16 · Implement owner billing and system-health recovery screens | proposed | #1077; consumes #1076, #1078–#1081 | `codex/zal-16-billing-system-health` | `6d65262` | Billing and system state are truthful, masked, and inspectable; gated financial/recovery actions cannot execute accidentally. | Binding Billing/System health contracts. | 2026-08-25 CEST | Wait for dependencies. |
| [#1083](https://github.com/zenod-ai/zenod/issues/1083) | Tester / integrator | unassigned | ZAL-17 · Prove a version-coherent Zenod Hosted beta release candidate | proposed | #1073–#1082, then ZAL-4 gates production | `codex/zal-17-beta-acceptance` | `6d65262` | All 21 screens and exact channel/customer/admin/self-host journeys pass on one named SHA with immutable-image and rollback evidence. | Binding contract and complete issue matrix. | 2026-08-25 CEST | Wait for implementation batch. |
...
| 2026-08-25 | Zenod WhatsApp audit, public-beta proposal, and binding 21-screen UI/backend contract | working tree from `6d65262` | Production Phylax/Ring/Zenod read-only stores and service metadata; repository customer/admin/edition code; standalone interactive HTML at 360/736/1024px; proposed GitHub issues #1073–#1083 | Reconciled 10 interactions and live bindings; current three/proposed Hosted two-service topology; supported one-container self-host shape; six Hosted, seven self-host, and eight admin screens; removed unimplemented reply settings; added spend, transport, and error analytics; created dependency-ordered backlog | product/UI contract approved and backlog proposed; no production, billing, session, signup, credential, user, or route mutation | `docs/evidence/zenod-whatsapp-public-beta-2026-08-25/index.html`; `docs/evidence/zenod-whatsapp-public-beta-2026-08-25/ui-contract.html`; issues #1073–#1083 |
