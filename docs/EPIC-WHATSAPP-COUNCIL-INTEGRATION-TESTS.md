...
| [#947](https://github.com/zenod-ai/zenod/issues/947) | Ticket worker | `wp2-transcription-sla` | W-P2 follow-up: bound and accelerate Phylax voice transcription | done | W-P2/W-P3 merged | [#953](https://github.com/zenod-ai/zenod/pull/953) / `codex/w-p2-transcription-sla` | `a99db25e`; rebased onto `1974e7e` | Preserve FIFO peak 1; bound transcription; typed failure handoff; truthful progress; exactly one terminal reply. | Merged `080fe729`; exact merged tree: 85 combined tests + server typecheck + CI + independent approval. Defaults/prewarms `small`; valid tenant model honored; owner-only progress; 60s typed timeout. | 2026-07-13 02:57 CEST | Gated production deploy and one real voice walk. |
| [#948](https://github.com/zenod-ai/zenod/issues/948) | Ticket worker | `wp3-log-timing` | W-P3 follow-up: redact Baileys session logs and persist timing audit | done | W-P3 merged | [#952](https://github.com/zenod-ai/zenod/pull/952) / `codex/w-p3-log-timing` | `a99db25e` | No session secrets in logs; safe health logs remain; additive provider-ID queue/transcription/downstream/outbound timings. | Merged `1974e7ee`; 57 tests + typecheck + CI + independent approval. Exact libsignal SessionEntry signatures redact; six nullable provider-ID timing columns persist. | 2026-07-13 02:48 CEST | Included in deploy candidate `080fe729`. |
