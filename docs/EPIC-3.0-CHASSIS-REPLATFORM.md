...
Next action: dispatch Phase 1 — Epic workers to 3.1 (chassis) and 3.2 (Zenod pilot). All architecture decisions D1–D8 are made.
Blockers: none for Phase 1. (Numbering resolved 2026-07-10: Herald moved to Epic 4 — `docs/EPIC-4-HERALD.md`. D4 resolved 2026-07-10: SQLite/WAL per unit. Remaining human gate for Phase 2: Epaminon spawner mechanism.)
