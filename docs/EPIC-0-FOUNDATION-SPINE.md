...
| ZLS | child | [Landing story](EPIC-ZENOD-LANDING-STORY.md) | Promote the approved Zenod story into a responsive landing-page journey, retouch slides 01–08, and add slides 09–10. | on hold — landing reverted | Story-deck landing integration reverted at user request; illustration-only section direction awaiting approval. | [Landing story spine](EPIC-ZENOD-LANDING-STORY.md), revert of PR #1339 | 2026-09-18 Europe/Paris | Await new landing direction; do not embed full slide images. |
