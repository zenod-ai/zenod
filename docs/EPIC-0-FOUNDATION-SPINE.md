...
|---|---|---|---|---|---|---|---|---|
| ZMR | child | [Memory Reliability](EPIC-ZENOD-MEMORY-RELIABILITY.md) | Complete passage/date-range recall, focused topic filing, and current-versus-historical answers. | active — typed retrieval | ZMR-delivery-manager coordinates; ZMR-4 review/CI diagnosis on dadd883; ZMR-1–3 integrated. | [September review](planning/zenod-memory-reliability-review.md); [#1199 merged](https://github.com/zenod-ai/zenod/pull/1199) | 2026-09-06 15:05 CEST | Review ZMR-4 typed retrieval, then dispatch topic-filing worker. |
