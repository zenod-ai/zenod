...
|---|---|---|---|---|---|---|---|---|
| ZMR | child | [Memory Reliability](EPIC-ZENOD-MEMORY-RELIABILITY.md) | Complete multi-idea filing and grounded recall using existing evidence pipeline. | acceptance repair | Second real-model candidate still fails semantic acceptance; production unchanged. | [ZMR-15 #1241](https://github.com/zenod-ai/zenod/issues/1241), contract repair #1261–#1263 | 2026-09-13 Europe/Paris | Review complete proposition, atomic decision and explicit answer-support contracts, then candidate acceptance. |
