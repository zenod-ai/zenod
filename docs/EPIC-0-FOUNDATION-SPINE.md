...
| ZLS | child | [Landing story](EPIC-ZENOD-LANDING-STORY.md) | Promote the approved Zenod story into a responsive landing-page journey, retouch slides 01–08, and add slides 09–10. | active — wave 1 review | PR #1339 merged; wave 1 image PRs #1346/#1347/#1350 open; hosted-price/legal decision open. | [Landing story spine](EPIC-ZENOD-LANDING-STORY.md), [#1340](https://github.com/zenod-ai/zenod/issues/1340)–[#1344](https://github.com/zenod-ai/zenod/issues/1344) | 2026-09-18 Europe/Paris | Review wave 1 images; resolve pricing; then integrate #1344. |
