...
|---|---|---|---|---|---|---|---|---|
| ZMR | child | [Memory Reliability](EPIC-ZENOD-MEMORY-RELIABILITY.md) | Complete passage/date-range recall, focused topic filing, and current-versus-historical answers. | active — release validation | ZMR-delivery-manager coordinates; ZMR-8 validation on 3f5ba09; ZMR-1–7 integrated. | [September review](planning/zenod-memory-reliability-review.md); [#1199 merged](https://github.com/zenod-ai/zenod/pull/1199) | 2026-09-06 19:35 CEST | Review integrated validation and exact release gate package. |
