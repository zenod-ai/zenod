...
|---|---|---|---|---|---|---|---|---|
| ZMR | child | [Memory Reliability](EPIC-ZENOD-MEMORY-RELIABILITY.md) | Complete multi-idea filing and grounded recall using existing evidence pipeline. | acceptance repair | Third candidate failed; offline source-native/typed-answer repairs active, provider quota blocked; production unchanged. | [ZMR-15 #1241](https://github.com/zenod-ai/zenod/issues/1241), contract repair #1268–#1269 | 2026-09-13 Europe/Paris | Repair contracts offline; restore provider quota before semantic/ASR acceptance and recovery. |
